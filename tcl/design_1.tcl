...
proc create_root_design { parentCell } {
  ...
  set RGB_GPIO [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 RGB_GPIO ]
...
\
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports RGB_GPIO] [get_bd_intf_pins RGB_LEDS/GPIO]
